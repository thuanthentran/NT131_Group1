...
#define BLYNK_TEMPLATE_ID "TMPL6bTiFZXI8"
#define BLYNK_TEMPLATE_NAME "NT131"
#define BLYNK_AUTH_TOKEN "ckFG2HmKPTeJYSEZWxVpNGM8XKymrvZj"


const char* telegramToken = "8104727157:AAG2uvUYiDdYxAZkIumigEdqO5vTJq4NQQw";
const char* chatID        = "6859576137";


const char* ssid = "Tiem Banh Nha Vi";
const char* password = "nhavicamon";
...
void setup() {
  ...
  myservo.setPeriodHertz(50);     // SG90 servo thường dùng 50Hz
  myservo.attach(SERVO_PIN, 500, 2400);  // chân, min, max xung tính bằng microseconds
